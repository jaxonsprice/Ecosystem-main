    ...
    for (const criteria of this.#targetCriteriaProviders) {
      ...
      for (const { operationalId, nodeId } of operationalTargets) {
        ...
        if (nodeId === void 0) {
          ...
          this.#operationalScanTargets.add(`${operationalIdString}-${import_types.NodeId.toHexString(nodeId)}`);
        }
      }
    }
