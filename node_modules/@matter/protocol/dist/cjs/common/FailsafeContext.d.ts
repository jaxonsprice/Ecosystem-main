...
export declare abstract class FailsafeContext {
     ...
     * validity checks.
     */
    createCertificateSigningRequest(isForUpdateNoc: boolean, sessionId: number): Promise<Uint8Array<ArrayBufferLike>>;
    removePaseSession(): Promise<void>;
    close(): Promise<void>;
    /** Handles adding a trusted root certificate from Operational Credentials cluster. */
    setRootCert(rootCert: Uint8Array): Promise<void>;
    /**
