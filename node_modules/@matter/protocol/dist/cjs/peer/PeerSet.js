...
class PeerSet {
  ...
  async #createGroupChannel(address) {
    ...
    const operationalInterface = this.#netInterfaces.interfaceFor(import_general.ChannelType.UDP, multicastAddress);
  ...
  async #doCasePair(unsecureMessageChannel, address, expectedProcessingTimeMs) {
    ...
    try {
      ...
      if (error instanceof import_SecureChannelMessenger.ChannelStatusResponseError && error.protocolStatusCode === import_types.SecureChannelStatusCode.NoSharedTrustRoots) {
