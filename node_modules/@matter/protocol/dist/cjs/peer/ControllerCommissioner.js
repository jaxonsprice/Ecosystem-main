...
class ControllerCommissioner {
  ...
  async #initializePaseSecureChannel(address, passcode, device) {
    ...
    const paseUnsecureMessageChannel = new import_MessageChannel.MessageChannel(paseChannel, unsecureSession);
    ...
    try {
      ...
      if (e instanceof import_SecureChannelMessenger.ChannelStatusResponseError) {
    ...
    return new import_MessageChannel.MessageChannel(paseChannel, paseSecureSession);
  }
