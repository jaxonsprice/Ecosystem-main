...
import { Environment, Environmental, MaybePromise, PromiseQueue, ServerAddressIp, Timer } from "#general";
...
export declare class InteractionClient {
    ...
    getAllAttributes(options?: {
        ...
        attributeChangeListener?: (data: DecodedAttributeReportValue<any>, valueChanged?: boolean, oldValue?: any) => void;
     ...
     */
    processAttributeUpdates(scope: ReadScope, attributeReports: DecodedAttributeReportValue<any>[], attributeListener?: (data: DecodedAttributeReportValue<any>, valueChanged?: boolean, oldValue?: any) => void): Promise<void>;
    ...
    getAllCachedClusterData(): DecodedAttributeReportValue<any>[];
}
