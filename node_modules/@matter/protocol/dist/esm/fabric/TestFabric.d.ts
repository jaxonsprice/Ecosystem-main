 ...
 */
export declare function TestFabric(options?: TestFabric.Options): Promise<import("./Fabric.js").Fabric>;
export declare namespace TestFabric {
    /**
     * WARNING: ONLY FOR USE IN PROTECTED TESTING ENVIRONMENTS WHERE SECURITY IS NOT A CONCERN
     *
     ...
     */
    function Authority({ index, fabrics }?: Options): Promise<FabricAuthority>;
    interface Options {
        index?: number;
        fabrics?: FabricManager;
    }
}
//# sourceMappingURL=TestFabric.d.ts.map