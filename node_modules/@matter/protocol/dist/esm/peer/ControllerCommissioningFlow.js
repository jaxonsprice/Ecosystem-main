...
class ControllerCommissioningFlow {
    ...
    for (const step of this.commissioningSteps) {
      ...
      try {
        ...
        if (this.#currentFailSafeEndTime !== void 0) {
          ...
          const timeLeft = Math.floor((this.#currentFailSafeEndTime - Time.nowMs()) / 1e3);
  ...
  async #armFailsafe(timeS) {
    ...
    this.#currentFailSafeEndTime = Time.nowMs() + expiryLengthSeconds * 1e3;
    return {
      code: 0 /* Success */,
      breadcrumb: this.lastBreadcrumb
    };
  ...
  get #failSafeTimeLeftS() {
    ...
    return Math.max(0, Math.ceil((this.#currentFailSafeEndTime - Time.nowMs()) / 1e3));
  }
