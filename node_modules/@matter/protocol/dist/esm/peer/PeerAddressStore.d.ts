...
export declare abstract class PeerDataStore {
    ...
    abstract retrieveAttribute(endpointId: EndpointNumber, clusterId: ClusterId, attributeId: AttributeId): DecodedAttributeReportValue<any> | undefined;
    ...
    abstract getClusterDataVersions(filterEndpointId?: EndpointNumber, filterClusterId?: ClusterId): {
