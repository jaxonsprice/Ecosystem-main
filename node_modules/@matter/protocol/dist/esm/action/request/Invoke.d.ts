 ...
 */
export declare function Invoke(options: Invoke.Definition): Invoke;
/**
 * Request invocation multiple commands with defined options
 */
export declare function Invoke(options: Invoke.Definition, ...commands: CommandData[]): Invoke;
/**
 * Request invocation multiple commands as list of Commands with default options.
 */
export declare function Invoke(...commands: CommandData[]): Invoke;
