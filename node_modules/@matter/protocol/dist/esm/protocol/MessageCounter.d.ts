...
export declare class MessageCounter {
     ...
     */
    constructor(crypto: Crypto, aboutToRolloverCallback?: (() => void) | undefined, rolloverInfoDifference?: number);
...
export declare class PersistedMessageCounter extends MessageCounter {
    ...
    static create(crypto: Crypto, storageContext: StorageContext, storageKey: string, aboutToRolloverCallback?: () => void, rolloverInfoDifference?: number): Promise<PersistedMessageCounter>;
    constructor(crypto: Crypto, storageContext: StorageContext, storageKey: string, aboutToRolloverCallback?: () => void, rolloverInfoDifference?: number);
    getIncrementedCounter(): Promise<number>;
}
