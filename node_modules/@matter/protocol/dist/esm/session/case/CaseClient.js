...
class CaseClient {
  ...
  async #doPair(messenger, exchange, fabric, peerNodeId) {
    ...
    if (sigma2Resume !== void 0) {
      ...
      logger.info(
        `Case client: Session ${secureSession.id} successfully resumed with ${messenger.getChannelName()} for Fabric ${NodeId.toHexString(fabric2.nodeId)} (index ${fabric2.fabricIndex}) and PeerNode ${NodeId.toHexString(peerNodeId)} with parameters`,
