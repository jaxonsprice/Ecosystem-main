 ...
 */
export declare function DataModelPath(id: string | number, type?: string): DataModelPath;
export declare namespace DataModelPath {
    const none: DataModelPath;
}
//# sourceMappingURL=DataModelPath.d.ts.map