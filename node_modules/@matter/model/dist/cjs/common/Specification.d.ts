...
export declare namespace Specification {
     ...
     */
    type Revision = `${number}.${number}` | `${number}.${number}.${number}` | `${number}.${number}.${number}.${number}`;
    /**
