...
class Constraint extends import_Aspect.Aspect {
  ...
  constructor(definition) {
    ...
    this.max = ast.max;
    this.in = ast.in;
    this.entry = ast.entry === void 0 ? void 0 : new Constraint(ast.entry);
    this.cpMax = ast.cpMax;
    this.parts = ast.parts?.length ? ast.parts.map((p) => new Constraint(p)) : void 0;
    this.isEmpty = this.desc === void 0 && this.value === void 0 && this.min === void 0 && this.max === void 0 && this.in === void 0 && this.entry === void 0 && this.cpMax === void 0 && this.parts === void 0;
    this.freeze();
  }
  extend(other) {
    if (other.isEmpty) {
...
((Constraint2) => {
  Constraint2.KEYWORDS = ["in", "min", "max", "to", "all", "desc", "true", "false"];
  Constraint2.keywords = new Set(Constraint2.KEYWORDS);
})(Constraint || (Constraint = {}));
var Serializer;
((Serializer2) => {
...
var Parser;
((Parser2) => {
  const lexer = new import_Lexer.Lexer(Constraint.KEYWORDS);
