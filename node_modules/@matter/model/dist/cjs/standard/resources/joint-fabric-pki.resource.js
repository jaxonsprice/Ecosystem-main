    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          tag: "field",
          name: "Icac",
          xref: "core\xA711.25.5.2.2",
          details: "If present, it shall contain the NOC Issuer Certificate in PEM format."
        }
      ]
    },
    { tag: "command", name: "TransferAnchorRequest", xref: "core\xA711.25.5" },
    { tag: "command", name: "TransferAnchorResponse", xref: "core\xA711.25.5" },
    { tag: "command", name: "TransferAnchorComplete", xref: "core\xA711.25.5" },
    {
      tag: "datatype",
...
//# sourceMappingURL=joint-fabric-pki.resource.js.map
