...
import_Resource.Resource.add(
  {
    ...
    children: [
      ...
      { tag: "datatype", name: "StartOfWeekEnum", xref: "cluster\xA74.3.8.24" },
      {
        tag: "datatype",
        name: "SystemModeEnum",
      ...
      },
      {
        ...
        xref: "cluster\xA74.3.8.33",
        children: [
          {
            tag: "field",
            name: "SystemMode",
            xref: "cluster\xA74.3.8.33.1",
