...
import_Resource.Resource.add({
  ...
  children: [
    { tag: "requirement", name: "WiFiNetworkManagement", xref: "device\xA715.2.4" },
    { tag: "requirement", name: "ThreadBorderRouterManagement", xref: "device\xA715.2.4" },
    { tag: "requirement", name: "ThreadNetworkDirectory", xref: "device\xA715.2.4" }
  ]
});
