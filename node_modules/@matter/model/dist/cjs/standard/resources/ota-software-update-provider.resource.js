...
See Section 11.20.3.2, \u201CQuerying the OTA Provider\u201D for additional details about the flow.`
          },
          {
            ...
            details: "This field indicates the version of the image being provided to the OTA Requestor by the OTA Provider when the Status is UpdateAvailable.\nThis field shall be present if it appears in a QueryImageResponse with a Status of UpdateAvailable.\nSee Section 11.20.3.2, \u201CQuerying the OTA Provider\u201D for additional details about the flow and acceptable values."
          },
          {
            tag: "field",
            name: "SoftwareVersionString",
            xref: "core\xA711.20.6.5.2.5",
            details: "This field provides a string version of the image being provided to the OTA Requestor by the OTA Provider when the Status is UpdateAvailable.\nThis field shall be present if it appears in a QueryImageResponse with a Status of UpdateAvailable.\nSee Section 11.20.3.2, \u201CQuerying the OTA Provider\u201D for additional details about the flow and acceptable values."
          },
          {
            tag: "field",
            name: "UpdateToken",
