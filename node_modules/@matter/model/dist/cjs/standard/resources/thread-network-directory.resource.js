...
import_Resource.Resource.add({
  ...
  children: [
    ...
    },
    {
      ...
      details: "This attribute shall indicate the maximum number of entries that can be held in the ThreadNetworks list; it shall be at least 2 times the number of SupportedFabrics advertised in the Operational Credentials Cluster on the root endpoint of this node."
    },
    {
      tag: "command",
      name: "AddNetwork",
