    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          { tag: "field", name: "Breadcrumb", xref: "core\xA711.9.7.3.3", details: "See Breadcrumb for usage." }
        ]
      },
      {
        tag: "command",
        ...
        children: [
          ...
          { tag: "field", name: "Breadcrumb", xref: "core\xA711.9.7.4.2", details: "See Breadcrumb for usage." }
        ]
      },
      {
        tag: "command",
        ...
        children: [
          ...
          { tag: "field", name: "Breadcrumb", xref: "core\xA711.9.7.6.2", details: "See Breadcrumb for usage." }
        ]
      },
      {
        tag: "command",
        ...
        children: [
          ...
          { tag: "field", name: "DebugText", xref: "core\xA711.9.7.7.2", details: "See DebugText for usage." },
          {
            tag: "field",
            name: "NetworkIndex",
      ...
      },
      {
        ...
        children: [
          ...
          { tag: "field", name: "Breadcrumb", xref: "core\xA711.9.7.8.2", details: "See Breadcrumb for usage." }
        ]
      },
      {
        tag: "command",
        ...
        children: [
          ...
          { tag: "field", name: "DebugText", xref: "core\xA711.9.7.9.2", details: "See DebugText for usage." },
          {
            tag: "field",
            name: "ErrorValue",
