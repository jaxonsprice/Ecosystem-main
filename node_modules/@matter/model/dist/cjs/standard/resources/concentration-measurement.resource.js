...
import_Resource.Resource.add({
  ...
  details: "The server cluster provides an interface to concentration measurement functionality. This cluster shall to be used via an alias to a specific substance (see Cluster IDs).",
  children: [
    {
      tag: "attribute",
      name: "FeatureMap",
    ...
    },
    {
      ...
      details: "This attribute shall represent the window of time used for determining the AverageMeasuredValue. The value is in seconds."
    },
    {
      tag: "attribute",
      name: "Uncertainty",
