...
import_Resource.Resource.add(
  {
    ...
    children: [
      ...
      },
      {
        ...
        details: "Indicates the alarm modes that will be emitted if the sensor is triggered.\nIf an alarm mode is not supported, the bit indicating this alarm mode shall always be 0. A bit shall indicate whether the alarm mode is enabled or disabled:\n  \u2022 0 = Disabled\n  \u2022 1 = Enabled"
      },
      {
        tag: "attribute",
        name: "AlarmsSupported",
        xref: "cluster\xA71.8.6.7",
        details: "Indicates the alarms supported by the sensor. A bit shall indicate whether the alarm mode is supported:\n  \u2022 0 = Not supported\n  \u2022 1 = Supported"
      },
      {
        tag: "attribute",
        name: "SensorFault",
