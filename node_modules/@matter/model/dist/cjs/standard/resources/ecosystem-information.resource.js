...
import_Resource.Resource.add({
  ...
  children: [
    ...
    },
    {
      ...
      xref: "core\xA79.18.4.1",
      children: [
        {
          tag: "field",
          name: "DeviceName",
          xref: "core\xA79.18.4.1.1",
    ...
    },
    {
      ...
      xref: "core\xA79.18.4.2",
      children: [
        {
          tag: "field",
          name: "UniqueLocationId",
          xref: "core\xA79.18.4.2.1",
