...
import_Resource.Resource.add({
  ...
  children: [
    ...
    { tag: "command", name: "Section112471", xref: "core\xA711.24.7" },
    { tag: "command", name: "Section112472", xref: "core\xA711.24.7" },
    { tag: "command", name: "Section112473", xref: "core\xA711.24.7" },
    { tag: "command", name: "Section112474", xref: "core\xA711.24.7" },
    { tag: "command", name: "Section112475", xref: "core\xA711.24.7" },
    { tag: "command", name: "Section112476", xref: "core\xA711.24.7" },
    { tag: "command", name: "Section112477", xref: "core\xA711.24.7" },
    { tag: "command", name: "Section112478", xref: "core\xA711.24.7" },
    { tag: "command", name: "Section112479", xref: "core\xA711.24.7" },
    { tag: "command", name: "Section1124710", xref: "core\xA711.24.7" },
    { tag: "command", name: "Section1124711", xref: "core\xA711.24.7" },
    { tag: "command", name: "Section1124712", xref: "core\xA711.24.7" },
    { tag: "command", name: "Section1124713", xref: "core\xA711.24.7" },
    { tag: "command", name: "Section1124714", xref: "core\xA711.24.7" },
    { tag: "command", name: "Section1124715", xref: "core\xA711.24.7" },
    { tag: "command", name: "Section1124716", xref: "core\xA711.24.7" },
    { tag: "command", name: "Section1124717", xref: "core\xA711.24.7" },
    { tag: "command", name: "Section1124718", xref: "core\xA711.24.7" },
    { tag: "command", name: "Section1124719", xref: "core\xA711.24.7" },
    { tag: "command", name: "Section1124720", xref: "core\xA711.24.7" },
    {
      tag: "datatype",
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          xref: "core\xA711.24.5.4.5",
          details: "Current version number for this CAT."
        },
        {
          tag: "field",
          name: "GroupPermission",
          xref: "core\xA711.24.5.4.6",
    ...
    {
      tag: "datatype",
      name: "DatastoreBindingEntry",
      xref: "core\xA711.24.5.4.7",
      children: [
        {
          tag: "field",
          name: "ListId",
          xref: "core\xA711.24.5.4.7.1",
          details: "The unique identifier for the Binding entry in the Datastore\u2019s list of DatastoreBindingEntry."
        },
        { tag: "field", name: "Binding", xref: "core\xA711.24.5.4.7.2", details: "The binding target structure." },
        {
          tag: "field",
          name: "StatusEntry",
          xref: "core\xA711.24.5.4.7.3",
          details: "Indicates whether entry in this list is pending, committed, or delete-pending."
        }
      ]
    },
    ...
    {
      tag: "datatype",
      name: "DatastoreNodeInformationEntry",
    ...
    },
    {
      ...
      children: [
        ...
        { tag: "field", name: "VendorId", xref: "core\xA711.24.5.9.3", details: "The Vendor ID for the node." },
        { tag: "field", name: "Icac", xref: "core\xA711.24.5.9.4", details: "The ICAC used to issue the NOC." }
      ]
    }
  ]
});
