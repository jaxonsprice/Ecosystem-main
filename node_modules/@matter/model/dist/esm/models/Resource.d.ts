...
export declare class ResourceBundle {
    #private;
    get(model: Model): Readonly<Resource> | undefined;
    add(resource: Resource.Named): void;
    static readonly default: ResourceBundle;
}
export declare namespace Resource {
    interface Named extends Definition {
        tag: `${ElementTag}`;
        name: string;
        discriminator?: string;
        children?: Named[];
    }
    type Definition = Omit<Resource, "xref"> & {
        xref?: CrossReference.Definition;
    };
    function add(named: Named): void;
    function discriminatorFor(model: Model): string | undefined;
}
