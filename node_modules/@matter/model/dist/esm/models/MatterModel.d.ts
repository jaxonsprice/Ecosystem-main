 ...
 */
export declare class MatterModel extends ScopeModel<MatterElement, MatterModel.Child> implements MatterElement {
    #private;
     ...
     */
    get permanentDatatypes(): Record<string, Model<import("../elements/BaseElement.js").BaseElement, Model<import("../elements/BaseElement.js").BaseElement, any>>>;
    /**
     * The resource pool for the node.
     */
    get resources(): ResourceBundle | undefined;
    ...
    toElement(omitResources?: boolean, extra?: Record<string, unknown>): MatterElement;
...
export declare namespace MatterModel {
    ...
    type Definition = Omit<Model.Definition<MatterModel>, "name" | "children"> & {
        name?: string;
