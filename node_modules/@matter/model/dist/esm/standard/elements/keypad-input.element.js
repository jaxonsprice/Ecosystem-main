...
const KeypadInput = Cluster(
  ...
  Command(
    ...
    Field({ name: "KeyCode", id: 0, type: "CecKeyCodeEnum", conformance: "M" })
  ),
  Command(
  ...
  Datatype(
    ...
    Field({ name: "UnsupportedKey", id: 1, conformance: "M" }),
    Field({ name: "InvalidKeyInCurrentState", id: 2, conformance: "M" })
  ),
  Datatype(
