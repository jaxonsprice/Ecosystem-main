...
const IcdManagement = Cluster(
  ...
  Attribute({ name: "OperatingMode", id: 8, type: "OperatingModeEnum", access: "R V", conformance: "LITS" }),
  Attribute({
  ...
  Command(
    ...
    Field({ name: "CheckInNodeId", id: 0, type: "node-id", conformance: "M" }),
    Field({ name: "MonitoredSubject", id: 1, type: "subject-id", conformance: "M" }),
    Field({ name: "Key", id: 2, type: "octstr", conformance: "M", constraint: "16" }),
    Field({ name: "VerificationKey", id: 3, type: "octstr", conformance: "O", constraint: "16" }),
    Field({ name: "ClientType", id: 4, type: "ClientTypeEnum", conformance: "M" })
  ),
  Command(
  ...
  Command(
    ...
    Field({ name: "CheckInNodeId", id: 0, type: "node-id", conformance: "M" }),
    Field({ name: "VerificationKey", id: 1, type: "octstr", conformance: "O", constraint: "16" })
  ),
  Command(
    {
  ...
  Datatype(
    ...
    Field({ name: "Permanent", id: 0, conformance: "M" }),
    Field({ name: "Ephemeral", id: 1, conformance: "M" })
  ),
  Datatype(
    { name: "OperatingModeEnum", type: "enum8" },
    Field({ name: "Sit", id: 0, conformance: "M" }),
    Field({ name: "Lit", id: 1, conformance: "M" })
  ),
  Datatype(
    { name: "MonitoringRegistrationStruct", type: "struct" },
    Field({ name: "CheckInNodeId", id: 1, type: "node-id", access: "S", conformance: "M", quality: "N" }),
    Field({ name: "MonitoredSubject", id: 2, type: "subject-id", access: "S", conformance: "M", quality: "N" }),
