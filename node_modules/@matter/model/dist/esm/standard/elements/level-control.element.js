...
const LevelControl = Cluster(
  ...
  Attribute({ name: "MinFrequency", id: 5, type: "uint16", access: "R V", conformance: "FQ", default: 0 }),
  Attribute({
    name: "MaxFrequency",
    id: 6,
    type: "uint16",
