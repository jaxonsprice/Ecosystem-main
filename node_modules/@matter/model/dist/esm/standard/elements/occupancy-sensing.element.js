...
const OccupancySensing = Cluster(
  ...
  Attribute({ name: "HoldTime", id: 3, type: "uint16", access: "RW VM", conformance: "O", constraint: "desc", quality: "N" }),
  Attribute({
    name: "HoldTimeLimits",
    id: 4,
  ...
  Datatype(
    ...
    Field({ name: "HoldTimeMax", id: 1, type: "uint16", conformance: "M", constraint: "min holdTimeMin, min 10" }),
    Field({
