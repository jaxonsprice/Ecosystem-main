...
Resource.add(
  {
    ...
    children: [
      ...
      },
      {
        ...
        details: "This attribute shall indicate what mechanism, if any, is in use for compensation for color/intensity drift over time."
      },
      {
        tag: "attribute",
      ...
      },
      {
        ...
        details: "This attribute shall indicate the minimum mired value supported by the hardware. ColorTempPhysicalMinMireds corresponds to the maximum color temperature in kelvins supported by the hardware.\nColorTempPhysicalMinMireds <= ColorTemperatureMireds."
      },
      {
        tag: "attribute",
        name: "ColorTempPhysicalMaxMireds",
        xref: "cluster\xA73.2.7.21",
        details: "This attribute shall indicate the maximum mired value supported by the hardware. ColorTempPhysicalMaxMireds corresponds to the minimum color temperature in kelvins supported by the hardware.\nColorTemperatureMireds <= ColorTempPhysicalMaxMireds."
      },
      {
        tag: "attribute",
