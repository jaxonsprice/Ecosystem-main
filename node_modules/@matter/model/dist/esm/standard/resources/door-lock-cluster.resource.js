...
Resource.add(
  {
    ...
    children: [
      ...
      },
      {
        ...
        details: "This attribute shall indicate the current operating mode of the lock as defined in OperatingModeEnum."
      },
      {
        tag: "attribute",
      ...
      },
      {
        ...
        children: [{ tag: "field", name: "PinCode", xref: "cluster\xA75.2.10.2.1", details: "See PINCode field." }]
      },
      { tag: "command", name: "Toggle", xref: "cluster\xA75.2.10" },
      {
        ...
        children: [
          ...
          { tag: "field", name: "PinCode", xref: "cluster\xA75.2.10.3.2", details: "See PINCode field." }
        ]
      },
      {
        tag: "command",
      ...
      },
      {
        ...
        children: [{ tag: "field", name: "PinCode", xref: "cluster\xA75.2.10.41.1", details: "See PINCode field." }]
      },
      {
        tag: "command",
