...
Resource.add({
  ...
  children: [
    ...
    },
    {
      ...
      details: "The computed current local time of the node as a epoch-us (Epoch Time in Microseconds). The value of LocalTime shall be the sum of the UTCTime, the offset of the currently valid TimeZoneStruct from the TimeZone attribute (converted to microseconds), and the offset of the currently valid DSTOffsetStruct from the DSTOffset attribute (converted to microseconds), if such an entry exists.\nIf the node has not achieved time synchronization, this shall be null. If the node has an empty DSTOffset, this shall be null."
    },
    {
      tag: "attribute",
    ...
    },
    {
      ...
      details: "If the node is running an RFC 5905 NTPv4 compliant server on port 123, this value shall be True. If the node is not currently running an NTP server, this value shall be False."
    },
    {
      tag: "attribute",
      name: "TimeZoneListMaxSize",
      xref: "core\xA711.17.8.11",
      details: "Number of supported list entries in the TimeZone attribute. This attribute may take the value of 1 or 2, where the optional second list entry may be used to handle scheduled regulatory time zone changes."
    },
    {
      tag: "attribute",
    ...
    },
    {
      ...
      details: "This attribute is true if the node supports resolving a domain name. DefaultNTP Address values for these nodes may include domain names. If this is False, the Address for a DefaultNTP shall be an IPv6 address."
    },
    {
      tag: "event",
      name: "DstTableEmpty",
    ...
    },
    {
      ...
      children: [{
        tag: "field",
        name: "DstOffsetsRequired",
        xref: "core\xA711.17.9.4.1",
        details: "If the node supports a time zone database with information for the time zone that will be applied, it may use this information to set the DSTOffset attribute. If the node is setting its own DSTOffset attribute, the DSTOffsetsRequired field shall be set to false, otherwise it shall be set to true."
      }]
    },
    {
      tag: "command",
