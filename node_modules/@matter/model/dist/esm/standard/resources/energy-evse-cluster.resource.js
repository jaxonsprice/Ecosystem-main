...
Resource.add(
  {
    ...
    children: [
      ...
      },
      {
        ...
        details: "Indicates the minimum current that can be delivered by the EVSE to the EV. The attribute can be set using the EnableCharging command."
      },
      {
        tag: "attribute",
      ...
      },
      {
        ...
        details: "Indicates the maximum current that can be received by the EVSE from the EV. This attribute can be set using the EnableDischarging command.\nThis attribute value shall be the minimum of:\n  \u2022 CircuitCapacity - Electrician\u2019s installation setting\n  \u2022 CableAssemblyCurrentLimit (detected by the EVSE when the cable is plugged in)\n  \u2022 MaximumDischargeCurrent field in the EnableDischarging command"
      },
      {
        tag: "attribute",
