...
export declare const AreaNamespaceTag: SemanticNamespace.Of<{
    ...
    readonly tags: {
        ...
        readonly DrawingRoom: {
            readonly id: 22;
            readonly label: "Drawing Room";
        };
        readonly DressingRoom: {
            readonly id: 23;
            readonly label: "Dressing Room";
        };
        readonly Driveway: {
            readonly id: 24;
        ...
        readonly FrontYard: {
            readonly id: 32;
            readonly label: "Front Yard";
        };
        readonly GameRoom: {
            readonly id: 33;
            readonly label: "Game Room";
        };
        readonly Garage: {
            readonly id: 34;
        ...
        readonly GuestBathroom: {
            readonly id: 38;
            readonly label: "Guest Bathroom";
        };
        readonly GuestBedroom: {
            readonly id: 39;
            readonly label: "Guest Bedroom";
        };
        readonly GuestRoom: {
            readonly id: 40;
            readonly label: "Guest Room";
        };
        readonly Gym: {
            readonly id: 41;
            readonly label: "Gym";
        ...
        readonly HearthRoom: {
            readonly id: 43;
            readonly label: "Hearth Room";
        };
        readonly KidsRoom: {
            readonly id: 44;
            readonly label: "Kids Room";
        };
        readonly KidsBedroom: {
            readonly id: 45;
            readonly label: "Kids Bedroom";
        };
        readonly Kitchen: {
            readonly id: 46;
        ...
        readonly MudRoom: {
            readonly id: 53;
            readonly label: "Mud Room";
        };
        readonly MusicRoom: {
            readonly id: 54;
            readonly label: "Music Room";
        };
        readonly Nursery: {
            readonly id: 55;
        ...
        readonly OutdoorKitchen: {
            readonly id: 57;
            readonly label: "Outdoor Kitchen";
        };
        readonly Outside: {
            readonly id: 58;
        ...
        readonly PlayRoom: {
            readonly id: 63;
            readonly label: "Play Room";
        };
        readonly PoolRoom: {
            readonly id: 64;
            readonly label: "Pool Room";
        };
        readonly Porch: {
            readonly id: 65;
        ...
        readonly PrimaryBathroom: {
            readonly id: 66;
            readonly label: "Primary Bathroom";
        };
        readonly PrimaryBedroom: {
            readonly id: 67;
            readonly label: "Primary Bedroom";
        };
        readonly Ramp: {
            readonly id: 68;
            readonly label: "Ramp";
        ...
        readonly ReceptionRoom: {
            readonly id: 69;
            readonly label: "Reception Room";
        };
        readonly RecreationRoom: {
            readonly id: 70;
            readonly label: "Recreation Room";
        };
        readonly Roof: {
            readonly id: 71;
            readonly label: "Roof";
        ...
        readonly SideYard: {
            readonly id: 77;
            readonly label: "Side Yard";
        };
        readonly SittingRoom: {
            readonly id: 78;
            readonly label: "Sitting Room";
        };
        /**
        ...
        readonly SteamRoom: {
            readonly id: 82;
            readonly label: "Steam Room";
        };
        readonly StorageRoom: {
            readonly id: 83;
            readonly label: "Storage Room";
        };
        readonly Studio: {
            readonly id: 84;
        ...
        readonly SunRoom: {
            readonly id: 86;
            readonly label: "Sun Room";
        };
        readonly SwimmingPool: {
            readonly id: 87;
            readonly label: "Swimming Pool";
        };
        readonly Terrace: {
            readonly id: 88;
