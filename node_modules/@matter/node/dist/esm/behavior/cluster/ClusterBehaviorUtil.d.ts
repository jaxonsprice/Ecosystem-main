 ...
 */
export declare function createType<const C extends ClusterType>(cluster: C, base: Behavior.Type, schema?: Schema, name?: string): ClusterBehavior.Type<any, Behavior.Type, import("./ClusterInterface.js").ClusterInterface<{}>>;
/**
