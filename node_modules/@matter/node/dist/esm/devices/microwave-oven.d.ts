...
export declare namespace MicrowaveOvenRequirements {
     ...
     */
    const OperationalStateServer: import("../index.js").ClusterBehavior.Type<import("@matter/types").ElementModifier.WithAlterations<import("@matter/types/clusters/operational-state").OperationalState.Cluster, {
        readonly attributes: {
    ...
    const server: {
        mandatory: {
            OperationalState: import("../index.js").ClusterBehavior.Type<import("@matter/types").ElementModifier.WithAlterations<import("@matter/types/clusters/operational-state").OperationalState.Cluster, {
                readonly attributes: {
                    readonly countdownTime: {
                        readonly optional: false;
                    };
...
export declare const MicrowaveOvenDeviceDefinition: MutableEndpoint.With<import("../index.js").EndpointType.For<{
    ...
    readonly behaviors: {
        readonly operationalState: import("../index.js").ClusterBehavior.Type<import("@matter/types").ElementModifier.WithAlterations<import("@matter/types/clusters/operational-state").OperationalState.Cluster, {
            readonly attributes: {
                readonly countdownTime: {
                    readonly optional: false;
                };
