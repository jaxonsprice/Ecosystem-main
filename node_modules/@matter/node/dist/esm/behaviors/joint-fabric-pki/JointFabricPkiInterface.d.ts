...
export declare namespace JointFabricPkiInterface {
    interface Base {
        /**
...
export type JointFabricPkiInterface = {
    components: [{
        flags: {};
        methods: JointFabricPkiInterface.Base;
    }];
};
//# sourceMappingURL=JointFabricPkiInterface.d.ts.map