...
export declare namespace ValidProxiesInterface {
    interface Base {
        /**
...
export type ValidProxiesInterface = {
    components: [{
        flags: {};
        methods: ValidProxiesInterface.Base;
    }];
};
//# sourceMappingURL=ValidProxiesInterface.d.ts.map