...
export declare namespace ProxyDiscoveryInterface {
    interface Base {
        /**
...
export type ProxyDiscoveryInterface = {
    components: [{
        flags: {};
        methods: ProxyDiscoveryInterface.Base;
    }];
};
//# sourceMappingURL=ProxyDiscoveryInterface.d.ts.map