...
export declare const RadonConcentrationMeasurementClientConstructor: ClusterBehavior.Type<RadonConcentrationMeasurement.Complete, typeof ClusterBehavior, {
    components: never[];
}>;
