...
const groupKeySetStructFS = groupKeySetStruct.extend({
  ...
  children: [(0, import_model.FieldElement)({ name: "FabricIndex", id: 254, type: "FabricIndex" })]
});
const schema = import_GroupKeyManagementBehavior.GroupKeyManagementBehavior.schema.extend({
  children: [
    groupKeySetStructFS,
    (0, import_model.FieldElement)({ name: "groupKeySets", type: "GroupKeySetStructFS", quality: "N", access: "RW VM F" })
  ]
});
class GroupKeyManagementServer extends import_GroupKeyManagementBehavior.GroupKeyManagementBehavior {
  ...
  initialize() {
    ...
    if (this.state.groupKeySets === void 0) {
  ...
  async keySetWrite({ groupKeySet }) {
    import_protocol.SecureSession.assert(this.session);
    const {
      groupKeySetId,
      epochKey0,
      epochKey1,
