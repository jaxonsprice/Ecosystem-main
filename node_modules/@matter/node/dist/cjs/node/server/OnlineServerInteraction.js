...
class OnlineServerInteraction {
  ...
  subscribe(_request, _context) {
    throw new import_general.NotImplementedError("invoke not implemented");
  }
  async write(request, context) {
    return (0, import_OnlineContext.OnlineContext)(context).act((session) => this.#interaction.write(request, session));
  }
  async *invoke(request, context) {
    const session = (0, import_OnlineContext.OnlineContext)({ ...context, command: true }).open();
    try {
