...
var import_JointFabricPkiServer = require("../behaviors/joint-fabric-pki/JointFabricPkiServer.js");
...
((JointFabricAdministratorRequirements2) => {
  ...
  JointFabricAdministratorRequirements2.JointFabricPkiServer = import_JointFabricPkiServer.JointFabricPkiServer;
  JointFabricAdministratorRequirements2.server = {
    mandatory: { JointFabricDatastore: JointFabricAdministratorRequirements2.JointFabricDatastoreServer, JointFabricPki: JointFabricAdministratorRequirements2.JointFabricPkiServer }
  };
})(JointFabricAdministratorRequirements || (JointFabricAdministratorRequirements = {}));
