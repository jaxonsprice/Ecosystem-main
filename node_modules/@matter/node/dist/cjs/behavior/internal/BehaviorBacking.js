...
class BehaviorBacking {
  ...
  [import_general.Construction.construct](agent) {
    ...
    try {
      ...
      return import_general.MaybePromise.then(promise, () => this.#endpoint.env.get(import_ProtocolService.ProtocolService).addCluster(this), crash);
    } catch (e) {
      crash(e);
    }
  }
  ...
  get datasourceOptions() {
    return {
      crypto: this.#endpoint.env.get(import_general.Crypto),
      location: {
