 ...
 */
export declare function ManagedReference(parent: Val.Reference<Val.Collection>, primaryKey: "name" | "id", name: string | number, id: number | undefined, assertWriteOk: (value: Val) => void, clone: (container: Val) => Val): Val.Reference<unknown>;
