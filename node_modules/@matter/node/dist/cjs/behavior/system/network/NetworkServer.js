...
class NetworkServer extends import_NetworkBehavior.NetworkBehavior {
  initialize() {
    if (this.state.ble === void 0) {
      this.state.ble = import_protocol.Ble.enabled;
    } else if (this.state.ble && !import_protocol.Ble.enabled) {
    ...
    this.reactTo(this.agent.get(import_CommissioningServer.CommissioningServer).events.commissioned, this.#endUncommissionedMode);
