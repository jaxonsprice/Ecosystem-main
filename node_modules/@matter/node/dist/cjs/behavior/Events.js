...
class OnlineEvent extends ElementEvent {
  ...
  #connectWithOccuranceManager() {
    if (this.owner.endpoint === void 0) {
      throw new import_general.ImplementationError("Event is not assigned to an endpoint");
    }
    const occurrenceManager = this.owner.endpoint.env.get(import_protocol.OccurrenceManager);
