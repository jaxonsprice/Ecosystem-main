...
var ballast_configuration_exports = {};
__export(ballast_configuration_exports, {
  BallastConfiguration: () => BallastConfiguration,
  BallastConfigurationCluster: () => BallastConfigurationCluster
});
module.exports = __toCommonJS(ballast_configuration_exports);
...
((BallastConfiguration2) => {
  BallastConfiguration2.BallastStatus = {
     ...
     */
    ballastNonOperational: (0, import_BitmapSchema.BitFlag)(0),
    /**
     ...
     */
    lampFailure: (0, import_BitmapSchema.BitFlag)(1)
  };
  BallastConfiguration2.LampAlarmMode = {
     ...
     */
    lampBurnHours: (0, import_BitmapSchema.BitFlag)(0)
  };
  BallastConfiguration2.ClusterInstance = (0, import_MutableCluster.MutableCluster)({
    id: 769,
    ...
    attributes: {
       ...
       */
      physicalMinLevel: (0, import_Cluster.Attribute)(0, import_TlvNumber.TlvUInt8.bound({ min: 1, max: 254 }), { default: 1 }),
      /**
       ...
       */
      physicalMaxLevel: (0, import_Cluster.Attribute)(1, import_TlvNumber.TlvUInt8.bound({ min: 1, max: 254 }), { default: 254 }),
      /**
       ...
       */
      ballastStatus: (0, import_Cluster.OptionalAttribute)(2, (0, import_TlvNumber.TlvBitmap)(import_TlvNumber.TlvUInt8, BallastConfiguration2.BallastStatus)),
      /**
       ...
       */
      minLevel: (0, import_Cluster.WritableAttribute)(16, import_TlvNumber.TlvUInt8, { writeAcl: import_model.AccessLevel.Manage }),
      /**
       * This attribute shall specify the light output of the ballast according to the dimming light curve (see
       ...
       */
      maxLevel: (0, import_Cluster.WritableAttribute)(17, import_TlvNumber.TlvUInt8, { writeAcl: import_model.AccessLevel.Manage }),
      /**
       ...
       */
      intrinsicBallastFactor: (0, import_Cluster.OptionalWritableAttribute)(
        20,
       ...
       */
      ballastFactorAdjustment: (0, import_Cluster.OptionalWritableAttribute)(
        21,
        (0, import_TlvNullable.TlvNullable)(import_TlvNumber.TlvUInt8.bound({ min: 100 })),
        { default: null, writeAcl: import_model.AccessLevel.Manage }
      ),
      /**
       ...
       */
      lampQuantity: (0, import_Cluster.Attribute)(32, import_TlvNumber.TlvUInt8),
      /**
       ...
       */
      lampType: (0, import_Cluster.OptionalWritableAttribute)(
        48,
        import_TlvString.TlvString.bound({ maxLength: 16 }),
        { writeAcl: import_model.AccessLevel.Manage }
      ),
      /**
       ...
       */
      lampManufacturer: (0, import_Cluster.OptionalWritableAttribute)(
        49,
        import_TlvString.TlvString.bound({ maxLength: 16 }),
        { writeAcl: import_model.AccessLevel.Manage }
      ),
       ...
       */
      lampRatedHours: (0, import_Cluster.OptionalWritableAttribute)(
        50,
       ...
       */
      lampBurnHours: (0, import_Cluster.OptionalWritableAttribute)(
        51,
        (0, import_TlvNullable.TlvNullable)(import_TlvNumber.TlvUInt24),
       ...
       */
      lampAlarmMode: (0, import_Cluster.OptionalWritableAttribute)(
        52,
        (0, import_TlvNumber.TlvBitmap)(import_TlvNumber.TlvUInt8, BallastConfiguration2.LampAlarmMode),
        { writeAcl: import_model.AccessLevel.Manage }
      ),
      /**
       ...
       */
      lampBurnHoursTripPoint: (0, import_Cluster.OptionalWritableAttribute)(
        53,
        (0, import_TlvNullable.TlvNullable)(import_TlvNumber.TlvUInt24),
        { default: null, writeAcl: import_model.AccessLevel.Manage }
      )
...
import_ClusterRegistry.ClusterRegistry.register(BallastConfiguration.Complete);
