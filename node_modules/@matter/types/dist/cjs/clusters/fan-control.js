...
((FanControl2) => {
  ...
  FanControl2.MultiSpeedComponent = import_MutableCluster.MutableCluster.Component({
    attributes: {
       ...
       */
      speedSetting: (0, import_Cluster.WritableAttribute)(5, (0, import_TlvNullable.TlvNullable)(import_TlvNumber.TlvUInt8), { default: 0 }),
      /**
  ...
  FanControl2.AirflowDirectionComponent = import_MutableCluster.MutableCluster.Component({
    attributes: {
       ...
       */
      airflowDirection: (0, import_Cluster.WritableAttribute)(
        11,
  ...
  FanControl2.Base = import_MutableCluster.MutableCluster.Component({
    ...
    attributes: {
       ...
       */
      fanMode: (0, import_Cluster.WritableAttribute)(0, (0, import_TlvNumber.TlvEnum)(), { persistent: true, default: 0 /* Off */ }),
      /**
       ...
       */
      percentSetting: (0, import_Cluster.WritableAttribute)(2, (0, import_TlvNullable.TlvNullable)(import_TlvNumber.TlvPercent), { default: 0 }),
      /**
       * Indicates the actual currently operating fan speed, or zero to indicate that the fan is off. There may be
