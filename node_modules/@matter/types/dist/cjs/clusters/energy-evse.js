...
((EnergyEvse2) => {
  ...
  EnergyEvse2.V2XComponent = import_MutableCluster.MutableCluster.Component({
    attributes: {
       ...
       */
      dischargingEnabledUntil: (0, import_Cluster.Attribute)(4, (0, import_TlvNullable.TlvNullable)(import_TlvNumber.TlvEpochS), { persistent: true, default: 0 }),
      /**
       ...
       */
      maximumDischargeCurrent: (0, import_Cluster.Attribute)(8, import_TlvNumber.TlvInt64.bound({ min: 0 }), { persistent: true, default: 0 }),
      /**
       * @see {@link MatterSpecification.v141.Cluster} § 9.3.8
       */
      sessionEnergyDischarged: (0, import_Cluster.Attribute)(
        67,
        (0, import_TlvNullable.TlvNullable)(import_TlvNumber.TlvInt64.bound({ min: 0 })),
  ...
  EnergyEvse2.ChargingPreferencesComponent = import_MutableCluster.MutableCluster.Component({
    attributes: {
       ...
       */
      nextChargeStartTime: (0, import_Cluster.Attribute)(35, (0, import_TlvNullable.TlvNullable)(import_TlvNumber.TlvEpochS), { default: null }),
      /**
       ...
       */
      nextChargeTargetTime: (0, import_Cluster.Attribute)(36, (0, import_TlvNullable.TlvNullable)(import_TlvNumber.TlvEpochS), { default: null }),
      /**
       ...
       */
      nextChargeRequiredEnergy: (0, import_Cluster.Attribute)(37, (0, import_TlvNullable.TlvNullable)(import_TlvNumber.TlvInt64.bound({ min: 0 })), { default: null }),
      /**
       ...
       */
      nextChargeTargetSoC: (0, import_Cluster.Attribute)(38, (0, import_TlvNullable.TlvNullable)(import_TlvNumber.TlvPercent), { default: null }),
      /**
  ...
  EnergyEvse2.SoCReportingComponent = import_MutableCluster.MutableCluster.Component({
    attributes: {
       ...
       */
      stateOfCharge: (0, import_Cluster.Attribute)(48, (0, import_TlvNullable.TlvNullable)(import_TlvNumber.TlvPercent), { default: null }),
      /**
       ...
       */
      batteryCapacity: (0, import_Cluster.Attribute)(49, (0, import_TlvNullable.TlvNullable)(import_TlvNumber.TlvInt64.bound({ min: 0 })), { default: null })
    }
  });
  EnergyEvse2.PlugAndChargeComponent = import_MutableCluster.MutableCluster.Component({
    attributes: {
       ...
       */
      vehicleId: (0, import_Cluster.Attribute)(50, (0, import_TlvNullable.TlvNullable)(import_TlvString.TlvString.bound({ maxLength: 32 })), { default: null })
    }
  });
  EnergyEvse2.RfidComponent = import_MutableCluster.MutableCluster.Component({
    events: {
       ...
       */
      rfid: (0, import_Cluster.OptionalEvent)(5, import_Cluster.EventPriority.Info, EnergyEvse2.TlvRfidEvent)
    }
  });
  EnergyEvse2.Base = import_MutableCluster.MutableCluster.Component({
    ...
    attributes: {
       ...
       */
      chargingEnabledUntil: (0, import_Cluster.Attribute)(3, (0, import_TlvNullable.TlvNullable)(import_TlvNumber.TlvEpochS), { persistent: true, default: 0 }),
      /**
       ...
       */
      circuitCapacity: (0, import_Cluster.Attribute)(5, import_TlvNumber.TlvInt64.bound({ min: 0 }), { persistent: true, default: 0 }),
      /**
       ...
       */
      minimumChargeCurrent: (0, import_Cluster.Attribute)(6, import_TlvNumber.TlvInt64.bound({ min: 0 }), { persistent: true, default: 6e3 }),
      /**
       ...
       */
      maximumChargeCurrent: (0, import_Cluster.Attribute)(7, import_TlvNumber.TlvInt64.bound({ min: 0 }), { persistent: true, default: 0 }),
      /**
       ...
       * @see {@link MatterSpecification.v141.Cluster} § 9.3.8
       */
      sessionId: (0, import_Cluster.Attribute)(64, (0, import_TlvNullable.TlvNullable)(import_TlvNumber.TlvUInt32), { persistent: true, default: null }),
      /**
       * @see {@link MatterSpecification.v141.Cluster} § 9.3.8
       */
      sessionDuration: (0, import_Cluster.Attribute)(65, (0, import_TlvNullable.TlvNullable)(import_TlvNumber.TlvUInt32), { persistent: true, default: null }),
      /**
       * @see {@link MatterSpecification.v141.Cluster} § 9.3.8
       */
      sessionEnergyCharged: (0, import_Cluster.Attribute)(
        66,
        (0, import_TlvNullable.TlvNullable)(import_TlvNumber.TlvInt64.bound({ min: 0 })),
        { persistent: true, default: null }
      )
    ...
    events: {
       ...
       */
      evConnected: (0, import_Cluster.Event)(0, import_Cluster.EventPriority.Info, EnergyEvse2.TlvEvConnectedEvent),
      /**
       ...
       */
      evNotDetected: (0, import_Cluster.Event)(1, import_Cluster.EventPriority.Info, EnergyEvse2.TlvEvNotDetectedEvent),
      /**
       ...
       */
      energyTransferStarted: (0, import_Cluster.Event)(2, import_Cluster.EventPriority.Info, EnergyEvse2.TlvEnergyTransferStartedEvent),
      /**
       ...
       */
      energyTransferStopped: (0, import_Cluster.Event)(3, import_Cluster.EventPriority.Info, EnergyEvse2.TlvEnergyTransferStoppedEvent),
      /**
       ...
       */
      fault: (0, import_Cluster.Event)(4, import_Cluster.EventPriority.Critical, EnergyEvse2.TlvFaultEvent)
    },
    /**
