...
((ValveConfigurationAndControl2) => {
  ...
  ValveConfigurationAndControl2.TimeSyncComponent = MutableCluster.Component({
    attributes: {
       ...
       */
      autoCloseTime: Attribute(2, TlvNullable(TlvEpochUs), { default: null })
    }
  });
  ValveConfigurationAndControl2.LevelComponent = MutableCluster.Component({
    attributes: {
       ...
       */
      currentLevel: Attribute(6, TlvNullable(TlvPercent), { default: null }),
      /**
       ...
       */
      targetLevel: Attribute(7, TlvNullable(TlvPercent), { default: null }),
      /**
  ...
  ValveConfigurationAndControl2.Base = MutableCluster.Component({
    ...
    attributes: {
       ...
       */
      openDuration: Attribute(0, TlvNullable(TlvUInt32.bound({ min: 1 })), { default: null }),
      /**
       ...
       */
      remainingDuration: Attribute(3, TlvNullable(TlvUInt32), { default: null }),
      /**
       ...
       */
      currentState: Attribute(4, TlvNullable(TlvEnum()), { default: null }),
      /**
       ...
       */
      targetState: Attribute(5, TlvNullable(TlvEnum()), { default: null }),
      /**
    ...
    events: {
       ...
       */
      valveStateChanged: OptionalEvent(0, EventPriority.Info, ValveConfigurationAndControl2.TlvValveStateChangedEvent),
      /**
       ...
       */
      valveFault: OptionalEvent(1, EventPriority.Info, ValveConfigurationAndControl2.TlvValveFaultEvent)
    },
    /**
