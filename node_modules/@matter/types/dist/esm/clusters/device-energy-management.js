...
((DeviceEnergyManagement2) => {
  ...
  DeviceEnergyManagement2.PowerAdjustmentComponent = MutableCluster.Component({
    attributes: {
       ...
       */
      powerAdjustmentCapability: Attribute(5, TlvNullable(DeviceEnergyManagement2.TlvPowerAdjustCapability), { default: null })
    },
    commands: {
      /**
    ...
    events: {
       ...
       */
      powerAdjustStart: Event(0, EventPriority.Info, TlvNoArguments),
      /**
       * This event shall be generated when the Power Adjustment session ends.
       *
       * @see {@link MatterSpecification.v141.Cluster} § 9.2.10.2
       */
      powerAdjustEnd: Event(1, EventPriority.Info, DeviceEnergyManagement2.TlvPowerAdjustEndEvent)
    }
  });
  DeviceEnergyManagement2.PowerForecastReportingOrStateForecastReportingComponent = MutableCluster.Component({
    attributes: {
       ...
       */
      forecast: Attribute(6, TlvNullable(DeviceEnergyManagement2.TlvForecast), { default: null })
    }
  });
  DeviceEnergyManagement2.PowerAdjustmentOrStartTimeAdjustmentOrPausableOrForecastAdjustmentOrConstraintBasedAdjustmentComponent = MutableCluster.Component({
    attributes: {
       ...
       */
      optOutState: Attribute(7, TlvEnum(), { default: 0 /* NoOptOut */ })
    }
  });
  DeviceEnergyManagement2.PausableComponent = MutableCluster.Component({
    ...
    events: {
       ...
       */
      paused: Event(2, EventPriority.Info, TlvNoArguments),
      /**
       ...
       */
      resumed: Event(3, EventPriority.Info, DeviceEnergyManagement2.TlvResumedEvent)
    }
  });
  ...
  DeviceEnergyManagement2.Base = MutableCluster.Component({
    ...
    attributes: {
       ...
       */
      esaType: FixedAttribute(0, TlvEnum(), { default: 255 /* Other */ }),
      /**
       ...
       */
      esaCanGenerate: FixedAttribute(1, TlvBoolean, { default: false }),
      /**
       ...
       */
      esaState: Attribute(2, TlvEnum(), { default: 0 /* Offline */ }),
      /**
       ...
       */
      absMinPower: Attribute(3, TlvInt64, { default: 0 }),
      /**
       ...
       */
      absMaxPower: Attribute(4, TlvInt64, { default: 0 })
    },
    /**
