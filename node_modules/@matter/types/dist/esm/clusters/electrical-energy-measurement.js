...
((ElectricalEnergyMeasurement2) => {
  ...
  ElectricalEnergyMeasurement2.ImportedEnergyAndCumulativeEnergyComponent = MutableCluster.Component({
    attributes: {
       ...
       */
      cumulativeEnergyImported: Attribute(1, TlvNullable(ElectricalEnergyMeasurement2.TlvEnergyMeasurement), { default: null })
    }
  });
  ElectricalEnergyMeasurement2.ExportedEnergyAndCumulativeEnergyComponent = MutableCluster.Component({
    attributes: {
       ...
       */
      cumulativeEnergyExported: Attribute(2, TlvNullable(ElectricalEnergyMeasurement2.TlvEnergyMeasurement), { default: null })
    }
  });
  ElectricalEnergyMeasurement2.ImportedEnergyAndPeriodicEnergyComponent = MutableCluster.Component({
    attributes: {
       ...
       */
      periodicEnergyImported: Attribute(3, TlvNullable(ElectricalEnergyMeasurement2.TlvEnergyMeasurement), { default: null })
    }
  });
  ElectricalEnergyMeasurement2.ExportedEnergyAndPeriodicEnergyComponent = MutableCluster.Component({
    attributes: {
       ...
       */
      periodicEnergyExported: Attribute(4, TlvNullable(ElectricalEnergyMeasurement2.TlvEnergyMeasurement), { default: null })
    }
  });
  ElectricalEnergyMeasurement2.CumulativeEnergyComponent = MutableCluster.Component({
    ...
    events: {
       ...
       */
      cumulativeEnergyMeasured: Event(0, EventPriority.Info, ElectricalEnergyMeasurement2.TlvCumulativeEnergyMeasuredEvent)
    }
  });
  ElectricalEnergyMeasurement2.PeriodicEnergyComponent = MutableCluster.Component({
    events: {
       ...
       */
      periodicEnergyMeasured: Event(1, EventPriority.Info, ElectricalEnergyMeasurement2.TlvPeriodicEnergyMeasuredEvent)
    }
  });
