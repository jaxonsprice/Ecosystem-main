...
((WaterHeaterManagement2) => {
  ...
  WaterHeaterManagement2.EnergyManagementComponent = MutableCluster.Component({
    attributes: {
       ...
       */
      tankVolume: Attribute(2, TlvUInt16, { default: 0 }),
      /**
       ...
       */
      estimatedHeatRequired: Attribute(3, TlvInt64.bound({ min: 0 }), { default: 0 })
    }
  });
  WaterHeaterManagement2.TankPercentComponent = MutableCluster.Component({
    attributes: {
       ...
       */
      tankPercentage: Attribute(4, TlvPercent, { default: 0 })
    }
  });
  WaterHeaterManagement2.Base = MutableCluster.Component({
    ...
    attributes: {
       ...
       */
      boostState: Attribute(5, TlvEnum(), { default: 0 /* Inactive */ })
    },
    commands: {
      /**
    ...
    events: {
       ...
       */
      boostStarted: Event(0, EventPriority.Info, WaterHeaterManagement2.TlvBoostStartedEvent),
      /**
       ...
       */
      boostEnded: Event(1, EventPriority.Info, TlvNoArguments)
    },
    /**
