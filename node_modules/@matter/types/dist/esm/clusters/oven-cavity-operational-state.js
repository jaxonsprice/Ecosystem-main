...
((OvenCavityOperationalState2) => {
  ...
  OvenCavityOperationalState2.ClusterInstance = MutableCluster({
    ...
    events: {
       ...
       */
      operationalError: Event(0, EventPriority.Critical, OperationalState.TlvOperationalErrorEvent),
      /**
       ...
       */
      operationCompletion: OptionalEvent(1, EventPriority.Info, OperationalState.TlvOperationCompletionEvent)
    }
  });
