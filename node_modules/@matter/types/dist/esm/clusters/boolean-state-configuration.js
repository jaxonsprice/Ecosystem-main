...
((BooleanStateConfiguration2) => {
  ...
  BooleanStateConfiguration2.VisualOrAudibleComponent = MutableCluster.Component({
    ...
    events: {
       ...
       */
      alarmsStateChanged: Event(0, EventPriority.Info, BooleanStateConfiguration2.TlvAlarmsStateChangedEvent)
    }
  });
  ...
  BooleanStateConfiguration2.Base = MutableCluster.Component({
    ...
    events: {
       ...
       */
      sensorFault: OptionalEvent(1, EventPriority.Info, BooleanStateConfiguration2.TlvSensorFaultEvent)
    },
    /**
