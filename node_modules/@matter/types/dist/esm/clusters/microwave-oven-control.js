...
((MicrowaveOvenControl2) => {
  ...
  MicrowaveOvenControl2.PowerNumberLimitsComponent = MutableCluster.Component({
    attributes: {
       ...
       */
      minPower: FixedAttribute(3, TlvUInt8.bound({ min: 1, max: 99 }), { default: 10 }),
      /**
       ...
       */
      maxPower: FixedAttribute(4, TlvUInt8.bound({ max: 100 }), { default: 100 }),
      /**
       ...
       */
      powerStep: FixedAttribute(5, TlvUInt8, { default: 10 })
    }
  });
  ...
  MicrowaveOvenControl2.Base = MutableCluster.Component({
    ...
    attributes: {
       ...
       */
      cookTime: Attribute(0, TlvUInt32.bound({ min: 1 }), { default: 30 }),
      /**
