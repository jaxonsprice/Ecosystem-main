...
export declare namespace Diagnostic {
     ...
     */
    function flag(value: string): Diagnostic;
    /**
     ...
     */
    function added(value: unknown): Diagnostic;
    /**
     * Create a value identifying a resource that was removed.
     */
    function deleted(value: unknown): Diagnostic;
    /**
     ...
     */
    function dict(entries: object, suppressUndefinedValues?: boolean): Record<string, unknown> & Diagnostic;
    /**
     ...
     */
    function asFlags(flags: Record<string, unknown>): Diagnostic;
    /**
     * Convert an object with keys to a space-separated list of truthy keys.
     */
    function toFlagString(flags: Record<string, unknown>): string;
    /**
     * Extract message and stack diagnostic details.
     */
    function messageAndStackFor(error: unknown, parentStack?: string[]): {
        message: string;
        id?: string;
        path?: unknown;
        stack?: unknown[];
