...
((X9622) => {
  X9622.PublicKeyEcPrime256v1 = (key) => ({
    type: {
      algorithm: X9622.PublicKeyAlgorithmEcPublicKey,
      curve: X9622.PublicKeyAlgorithmEcPublicKeyP256
    },
    bytes: DerBitString(key)
  });
  X9622.EcdsaWithSHA256 = DerObject("2A8648CE3D040302");
  X9622.PublicKeyAlgorithmEcPublicKey = ObjectId("2A8648CE3D0201");
  X9622.PublicKeyAlgorithmEcPublicKeyP256 = ObjectId("2A8648CE3D030107");
})(X962 || (X962 = {}));
const SHA256_CMS = DerObject("608648016503040201");
var X509;
((X5092) => {
  X5092.SubjectKeyIdentifier = (identifier) => DerObject("551d0e", { value: DerCodec.encode(identifier) });
  X5092.AuthorityKeyIdentifier = (identifier) => DerObject("551d23", { value: DerCodec.encode({ id: ContextTaggedBytes(0, identifier) }) });
...
var Pkcs7;
((Pkcs72) => {
  Pkcs72.Data = (data) => DerObject("2A864886F70D010701", { value: ContextTagged(0, data) });
  Pkcs72.SignedData = (data) => DerObject("2a864886f70d010702", { value: ContextTagged(0, data) });
})(Pkcs7 || (Pkcs7 = {}));
var X520;
((X5202) => {
